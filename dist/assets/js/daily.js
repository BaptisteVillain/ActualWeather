...
var ActualWeather = function () {
    ...
    _createClass(ActualWeather, [{
        ...
        value: function initSvg(node) {
            ...
            var x1 = this.width / 2 + this.data_width / 2 * Math.cos(23 * 2 * Math.PI / 24);
            var y1 = this.width / 2 + this.data_width / 2 * Math.sin(23 * 2 * Math.PI / 24);

            var x2 = this.width / 2 + this.data_width / 2 * Math.cos(22 * 2 * Math.PI / 24);
            var y2 = this.width / 2 + this.data_width / 2 * Math.sin(22 * 2 * Math.PI / 24);
